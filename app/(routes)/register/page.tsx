  ...
  useEffect(() => {
    ...
    if (teamSize > currentTeamMembers.length) {
      const newMembers = Array.from(
        { length: teamSize - currentTeamMembers.length },
        () => ({
          name: "",
          email: "",
          phone: "",
      ...
      <div className="container max-w-2xl relative">
        ...
        <div className="text-center mb-12 relative">
          ...
          <p className="text-muted-foreground">
            Register for an unforgettable Ramadan hackathon experience
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center text-red-500">
            Error loading registration status. Please try again later.
          </div>
        ) : (
